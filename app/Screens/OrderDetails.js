        ...
        {orderDetails.status === 'completed' ? null : (
          <TouchableHighlight
            ...
            <View>
              ...
              />
              <Text style={styles.textStyle}>
                {orderDetails.status === 'pending' ? Start : Complete}
              </Text>
            </View>
          </TouchableHighlight>
        )}
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  handleOrderStatus(
                    orderDetails.id,
                    driverInfo.id,
                    orderDetails.status === 'pending' ? 'running' : 'completed',
                  );
                }}>
                <Icon
                ...
                <Text style={{...styles.textStyle, fontSize: 13}}>
                  {orderDetails.status === 'pending' ? Yes : NotPaid}
                </Text>
              </TouchableOpacity>
