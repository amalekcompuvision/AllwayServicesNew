...
const CurrentRequests = props => {
    ...
    const runingOrders = useSelector(state => state.orders.runingOrders);
    console.log('pendiiiiiiiiiiiiiiiiiiiiiiiiign');
    console.log(runingOrders[0].id);
    console.log('pendiiiiiiiiiiiiiiiiiiiiiiiiign');
    ...
    const handleSetOrderDetails = async (orderID) => {
      ...
      if (runingOrders[0].id == null || runingOrders[0].id === undefined) {
          return (
              <View
                        ...
                        >
                            ...
                            >
                                <View style={{ flexDirection: 'column' }}>
                                    ...
                                    <TouchableOpacity
                                            style={{ ...styles.openButton, justifyContent: 'center', backgroundColor: "red", alignSelf: 'center', width: (Dimensions.get('window').width - 20) / 2 }}
                                            onPress={() => {
                                                setModalVisible(!modalVisible);
                                        ...
                                        >
                                            ...
                                            <Icon name={'stop'} size={40} style={{ alignSelf: 'center', color: 'white' }} />
                                ...
                                >
                                    <View style={styles.centeredView}>
                                        <View style={styles.modalView}>
                                            ...
                                            <Text style={{ ...styles.textStyle, color: 'black', fontWeight:'bold', fontSize:20 }}>Was The Order paid ??</Text>
                                            ...
                                            >
                                                ...
                                                mode="contained" onPress={() => {
                                                 ...
                                                 handleOrderStatus(
                                                     ...
                                                     3,
                                                     'completed');
                                                    //  handleOrderStatusIfPaid(1, orderID);
                                            }}>
                                                   Yes
                                                 </Button>
