...
const CurrentRequests = (props) => {
  ...
  const runingOrders = useSelector((state) =>
    state?.orders?.runingOrders ? state.orders.runingOrders : null,
  );
  ...
  let WasPaid =
    language == 'EN' ? 'Was the order paid ?' : 'هل كان الطلب مدفوع ؟';
  let NotPaid = language == 'EN' ? 'Not Paid' : 'غير مدفوع';
  ...
  const handleOrderStatusIfPaid = async (isPaid, oID) => {
    let channgeStatusAction = orderStatusActions.setOrderStatusIfPaid(
      isPaid,
      oID,
    );
    try {
                  ...
                  <View style={styles.modalView}>
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        <Text style={styles.textDetails}>{NotPaid}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        style={{
                          ...styles.openButton,
                        ...
                        <Text style={styles.textDetails}>{Paid}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        style={{
                          ...styles.openButton,
                        ...
                        <Text style={styles.textDetails}>{Cancel}</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                </View>
